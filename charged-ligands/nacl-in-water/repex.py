...
class ReplicaExchange(object):
    ...
    * Add HDF5 support.
    ...
    def _addMonteCarloBarostat(self, system, pressure=None, temperature=None, frequency=None):
        ...
        pressure (simtk.unit.Quantity compatible with pressure) - barostat pressure
        temperature (simtk.unit.Quantity compatible with temperature) - simulation temperature
        ...
        if 'MonteCarloBarostat' in forces_dict:
            force = forces_dict['MonteCarloBarostat']
            if pressure: force.setPressure(pressure)
